...
## The Configured Provider Gets Instructions

`ProviderModelClient` still hides provider-specific details and credential
shape, but now it should tell the model about the tiny text protocol.
